...
public class crawler6leg : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        // Rewards
        float distanceToTarget = Vector3.Distance(this.transform.localPosition, m_Target.localPosition);
    ...
    void FixedUpdate()
    {
        ...
        if (useFootGroundedVisualization)
        {
            ...
            foot3.material = m_JdController.bodyPartsDict[leg3Lower].groundContact.touchingGround
                ? groundedMaterial
                : unGroundedMaterial;
            foot3.material = m_JdController.bodyPartsDict[leg2Lower].groundContact.touchingGround
                ? groundedMaterial
                : unGroundedMaterial;
            foot4.material = m_JdController.bodyPartsDict[leg3Lower].groundContact.touchingGround
                ? groundedMaterial
                : unGroundedMaterial;
        }
