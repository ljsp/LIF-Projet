...
public class CrawlerModified : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        body.rotation = Quaternion.Euler(0, Random.Range(0.0f, 360.0f), -90);
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        bpDict[leg6Upper].SetJointTargetRotation(continuousActions[++i], continuousActions[++i], 0);
        bpDict[leg7Upper].SetJointTargetRotation(continuousActions[++i], continuousActions[++i], 0);
        ...
        bpDict[leg6Lower].SetJointTargetRotation(continuousActions[++i], 0, 0);
        bpDict[leg7Lower].SetJointTargetRotation(continuousActions[++i], 0, 0);
        ...
        bpDict[leg6Upper].SetJointStrength(continuousActions[++i]);
        bpDict[leg7Upper].SetJointStrength(continuousActions[++i]);
        ...
        bpDict[leg6Lower].SetJointStrength(continuousActions[++i]);
        bpDict[leg7Lower].SetJointStrength(continuousActions[++i]);
    }
    ...
    public void reward(float rewardAmount)
    {
